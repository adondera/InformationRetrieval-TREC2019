...
querystring = {}
with open("train/queries.doctrain.tsv", encoding='utf8') as f:
...
qrel = {}
with open("train/msmarco-doctrain-qrels.tsv", encoding='utf8') as f:
    tsvreader = csv.reader(f, delimiter=" ")
...
def generate_triples(outfile, triples_to_generate):
    ...
    with gzip.open("train/msmarco-doctrain-top100.gz", 'rt', encoding='utf8') as top100f, \
            open("collections/msmarco-doc/msmarco-docs.tsv", encoding="utf8") as f, \
...
stats = generate_triples("triples.tsv", 100000)
